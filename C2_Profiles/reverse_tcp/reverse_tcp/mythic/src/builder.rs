...
pub fn c2_parameters() -> Vec<C2Parameter> {
    vec![
        C2Parameter {
            name: "callback_host".to_string(),
            description: "Host to callback to".to_string(),
            default_value: serde_json::json!(""),
            parameter_type: parameter_type::STRING.to_string(),
            required: true,
        ...
        C2Parameter {
            ...
            description: "Variation in callbacks".to_string(),
            default_value: serde_json::json!(10),
            parameter_type: parameter_type::NUMBER.to_string(),
            required: false,
            verifier_regex: "^[0-9]+$".to_string(),
